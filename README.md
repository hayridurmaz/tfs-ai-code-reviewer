...
MAX_COMMENTS_PER_FILE=3         # Default safety limit for AI comments (fallback)
MAX_COMMENTS_PER_FILE_FIRST_REVIEW=5  # Total comment limit for first review
MAX_COMMENTS_PER_FILE_ITERATION=3     # Total comment limit for subsequent iterations
...
2.  **Automation:** Pushing a tag;
```git push origin v1.0.0```
   automatically triggers the GitHub Actions workflow which:
